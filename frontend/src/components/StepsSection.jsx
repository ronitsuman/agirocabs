...
const StepsSection = () => {
  // Hassle-free convenience as we take care of every detail, allowing you to unwind and embrace a journey filled with comfort
  return (
    <div className="hidden md:visible relative mt-14 w-[100%] py-12 px-6 lg:px-20 ">
      {/* Connecting Line */}
      <div className="absolute md:top-19   lg:top-19 lg:left-42   lg:w-[80%]   h-[0.2px] bg-[#E94E3A] hidden md:block"></div>
      ...
      <div className="relative flex flex-col  md:flex-row items-center  justify-between gap-8">
        {steps.map((step, index) => (
          ...
          >
            {/* Step Number */}
            <div className="w-12 h-12 bg-[#E94E3A] text-white flex items-center justify-center text-lg font-bold rounded-md relative z-10">
              {step.id}
            </div>
